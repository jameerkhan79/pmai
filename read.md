I want to create a web application (SaaS) for project managers. This application will allow project managers to add meeting notes and get a stuctured output from it. The structure of the output will be specified in the prompt given to LLM. The LLM prompt will have a System Prompt and a User prompt message.
